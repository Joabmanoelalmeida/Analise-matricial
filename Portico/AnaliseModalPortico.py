...
class Elemento:
    ...
    def matriz_massa_local(self):
        ...
        M = np.array([
            ...
            [0,                        (j1 * j7 + j1 * j8), (j1 * j2 + j1 * j8),    0,                        (j1 * j3 + j1 * j7), (j1 * j4 + j1 * j8)],
            [0,                        (j1 * j2 + j1 * j8), (j1 * j5 + j1 * j9),    0,                       -(j1 * j4 + j1 * j8), (j1 * j6 + j1 * j10)],
            [densidade * A * L / 6,    0,                     0,                     densidade * A * L / 3,    0,                     0],
            [0,                        (j1 * j3 + j1 * j7), -(j1 * j4 + j1 * j8),  0,                        (j1 * j1 + j1 * j7), -(j1 * j2 + j1 * j8)],
            [0,                        (j1 * j4 + j1 * j8), (j1 * j6 + j1 * j10),  0,                       -(j1 * j2 + j1 * j8), (j1 * j5 + j1 * j9)],
        ])
...
elemento1 = Elemento(id=1, no_inicial=n1, no_final=n2, E=210000, A=700, I=40000, qx=0, qy=0, poisson=0.3, densidade=7850)
elemento2 = Elemento(id=2, no_inicial=n2, no_final=n3, E=210000, A=700, I=40000, qx=0, qy=0, poisson=0.3, densidade=7850)
elemento3 = Elemento(id=3, no_inicial=n3, no_final=n4, E=210000, A=700, I=40000, qx=0, qy=0, poisson=0.3, densidade=7850)
